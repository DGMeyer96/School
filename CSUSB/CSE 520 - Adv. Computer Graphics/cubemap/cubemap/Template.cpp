...
void init2DTexture()
{
	...
	unsigned char* image =
		SOIL_load_image("floor.png", &width, &height, 0, SOIL_LOAD_RGB);
...
int init(void)
{
	...
	readShaderSource((char *)"cubemap.vert", &VertexShaderSource);
	readShaderSource((char *)"cubemap.frag", &FragmentShaderSource);
