...
//   glPolygonMode( GL_BACK,  GL_FILL ) ;
 ...
 //  glEnable(GL_LIGHT0);
 //  glEnable(GL_LIGHT1);
   glEnable(GL_DEPTH_TEST);  //should clear the buffer
}
...
void display(void)
{
   ...
   const int nx = 4;	//32;			//number of slices along x-direction
   const int ntheta = 64;	//64;		//number of angular slices
...
//   bspline ( ctrlpoints, x, v );        //temporary test, use startx = 0
