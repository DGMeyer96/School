/*
  ...
  Shader sources are in files "testfun.vert" and "testfun.frag".
  @Author: T.L. Yu, 2008
*/
#include <stdlib.h>
#include <stdio.h>
...
int init(void)
{
   ...
   printf("version=%s\n", version );
   readShaderSource((char *) "testfun.vert", &VertexShaderSource );
   readShaderSource( (char *) "testfun.frag", &FragmentShaderSource );
