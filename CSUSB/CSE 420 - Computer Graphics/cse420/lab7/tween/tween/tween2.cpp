...
{
	A[0].x = 3; A[0].y = 8;		A[1].x = 6.5;  A[1].y = 8;
	A[2].x = 6.5; A[2].y = 12;		A[3].x = 3;  A[3].y = 12;
	A[4].x = 3; A[4].y = 8;		A[5].x = 6.5;  A[5].y = 8;

	B[0].x = 3; B[0].y = 8;		B[1].x = 6.5;  B[1].y = 8;
	B[2].x = 6.5; B[2].y = 12;		B[3].x = 3;  B[3].y = 12; //Head
	B[4].x = 3; B[4].y = 8;		B[5].x = 6.5;  B[5].y = 8;
}

void makeMouth(Point2 A[], Point2 B[])
{
	A[0].x = 4;		A[0].y = 8.5;		A[1].x = 5.5;  A[1].y = 8.5;
	A[2].x = 5.5;	A[2].y = 9;			A[3].x = 4;    A[3].y = 9;
	A[4].x = 4;		A[4].y = 8.5;		A[5].x = 5.5;  A[5].y = 8.5;

	B[0].x = 4;		B[0].y = 8.5;		B[1].x = 5.5;  B[1].y = 8.5;
	B[2].x = 5.5;	B[2].y = 10;		B[3].x = 4;	   B[3].y = 10; //Mouth
	B[4].x = 4;		B[4].y = 8.5;		B[5].x = 5.5;  B[5].y = 8.5;
}

void makeLeftEye(Point2 A[], Point2 B[])
{
	A[0].x = 4;		A[0].y = 10.5;	A[1].x = 4.5;  A[1].y = 10.5;
	A[2].x = 4.5;	A[2].y = 12;	A[3].x = 4;    A[3].y = 12;
	A[4].x = 4;		A[4].y = 10.5;	A[5].x = 4.5;  A[5].y = 10.5;

	B[0].x = 4;		B[0].y = 10.5;	B[1].x = 4.5;  B[1].y = 10.5;
	B[2].x = 4.5;	B[2].y = 11;	B[3].x = 4;	   B[3].y = 11; 
	B[4].x = 4;		B[4].y = 10.5;	B[5].x = 4.5;  B[5].y = 10.5;
}

void makeRightEye(Point2 A[], Point2 B[])
{
	A[0].x = 5;		A[0].y = 10.5;		A[1].x = 5.5;  A[1].y = 10.5;
	A[2].x = 5.5;	A[2].y = 12;		A[3].x = 5;    A[3].y = 12;
	A[4].x = 5;		A[4].y = 10.5;		A[5].x = 5.5;  A[5].y = 10.5;

	B[0].x = 5;		B[0].y = 10.5;		B[1].x = 5.5;  B[1].y = 10.5;
	B[2].x = 5.5;	B[2].y = 11;		B[3].x = 5;	   B[3].y = 11;
	B[4].x = 5;		B[4].y = 10.5;		B[5].x = 5.5;  B[5].y = 10.5;
}
...
void display(void)
{
	...
	drawTween(A3, B3, 6, t, center);
	drawTween(A4, B4, 6, t, center);
	drawTween(A5, B5, 6, t, center);
	drawTween(A6, B6, 6, t, center);
