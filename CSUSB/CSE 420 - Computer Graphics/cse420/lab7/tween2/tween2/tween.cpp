...
{
	A[0].x = 0;   A[0].y = 0;     A[1].x = 3;     A[1].y = 0;
	A[2].x = 6;   A[2].y = 0;     A[3].x = 6;     A[3].y = -2;
	A[4].x = 4;   A[4].y = -2;    A[5].x = 4;     A[5].y = -4;
	A[6].x = 6;   A[6].y = -4;    A[7].x = 6;     A[7].y = -6;
	A[8].x = 0;   A[8].y = -6;		A[9].x = 0;		A[9].y = -4;
	A[10].x = 2;	A[10].y = -4;	A[11].x = 2;	A[11].y = -2;
	A[12].x = 0;   A[12].y = -2;
...
void init(void)
{
	...
	makeFigures(B, A);          //create figure A and B
	glLineWidth(2);
